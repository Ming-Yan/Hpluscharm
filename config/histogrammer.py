...
def create_hist():
    ...
    _hist_event_dict['template_HT_mass'] = Hist.Hist(
            
           syst_axis,
            lepflav_axis,
            region_axis,
            flav_axis,
            Hist.axis.Regular(50,0,1000, name="mass", label="$m$ [GeV]"),
            Hist.storage.Weight(),
        )
    ...
    _hist_event_dict['template_MET'] = Hist.Hist(
            syst_axis,
            lepflav_axis,
            region_axis,
            flav_axis,
    ...
    _hist_event_dict['template_jetpt'] = Hist.Hist(
            syst_axis,
            lepflav_axis,
            region_axis,
            flav_axis,
