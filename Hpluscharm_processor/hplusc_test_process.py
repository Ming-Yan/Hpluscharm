...
# }
    ...
    def process(self, events):
        ...
        if isRealData:
            ...
            #     weights.add('zptwei',flatten(ZpT_corr(genZ.pt,self._year)))
        ...
        elesel = ((event_e.pt > 13) &  (((abs(event_e.eta) < 2.5)&(abs(event_e.eta) > 1.57))|(abs(event_e)<1.4442))&(event_e.mvaFall17V2Iso_WP90==1)& (abs(event_e.dxy)<0.5)&(abs(event_e.dz)<1))
        ...
        req_global = ak.any((leppair.lep1.pt>25) & (ll_cand.mass>12) & (ll_cand.pt>30) & (leppair.lep1.charge+leppair.lep2.charge==0) & (events.MET.pt>20),axis=-1)
