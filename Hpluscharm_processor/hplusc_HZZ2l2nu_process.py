...
class NanoProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        req_global = (good_leptons[:,0].pt>25) & (ll_cand.pt>20) & (good_leptons[:,0].charge+good_leptons[:,1].charge==0) & (events.MET.pt>20) & ((abs(ll_cand.mass-91.)<15) | (abs(events.MET.pt-91.)<15)) & (good_leptons[:,0].delta_r(good_leptons[:,1]>0.02))
