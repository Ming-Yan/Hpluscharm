...
class NanoProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        sel_jet = eventcsv_jet[ak.all(eventcsv_jet.metric_table(pair_4lep.lep2)>0.4,axis=2)&ak.all(eventcsv_jet.metric_table(pair_4lep.lep3)>0.4,axis=2)&ak.all(eventcsv_jet.metric_table(pair_4lep.lep4)>0.4,axis=2)]
        ...
        sel_jetflav =  eventflav_jet[ak.all(eventflav_jet.metric_table(pair_4lep.lep1)>0.4,axis=2)&ak.all(eventflav_jet.metric_table(pair_4lep.lep2)>0.4,axis=2)&ak.all(eventflav_jet.metric_table(pair_4lep.lep3)>0.4,axis=2)&ak.all(eventflav_jet.metric_table(pair_4lep.lep4)>0.4,axis=2)]
        ...
        sel_jetpt =  eventpt_jet[ak.all(eventpt_jet.metric_table(pair_4lep.lep1)>0.4,axis=2)&ak.all(eventpt_jet.metric_table(pair_4lep.lep2)>0.4,axis=2)&ak.all(eventpt_jet.metric_table(pair_4lep.lep3)>0.4,axis=2)&ak.all(eventpt_jet.metric_table(pair_4lep.lep4)>0.4,axis=2)]
