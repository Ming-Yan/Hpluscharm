...
def histogram(cfg):
    ...
    output = {
        ...
        "ele_pt":Hist.Hist(lepflav_axis,region_axis,flav_axis, pt_axis,Hist.storage.Weight()),
        "mu_pt":Hist.Hist(lepflav_axis,region_axis,flav_axis, pt_axis,Hist.storage.Weight()),
        "lep1_pt":Hist.Hist(lepflav_axis,region_axis,flav_axis, pt_axis,Hist.storage.Weight()),
        "lep2_pt":Hist.Hist(lepflav_axis,region_axis,flav_axis,Hist.axis.Regular(50,0,150, name="pt", label=" $p_{T}$ [GeV]"),Hist.storage.Weight()),
        "mu_pt":Hist.Hist(lepflav_axis,region_axis,flav_axis, pt_axis,Hist.storage.Weight()),
        "ele_pt":Hist.Hist(lepflav_axis,region_axis,flav_axis, pt_axis,Hist.storage.Weight()),
        ...
        "mT2":Hist.Hist(lepflav_axis,region_axis,flav_axis,Hist.axis.Regular(30,30,150, name="mt", label=" $m_{T}$ [GeV]"),Hist.storage.Weight()),
        "mTh":Hist.Hist(lepflav_axis,region_axis,flav_axis,Hist.axis.Regular(60,0,300, name="mt"),Hist.storage.Weight()),
        "ll_mass":Hist.Hist(lepflav_axis,region_axis,flav_axis,mass_axis,Hist.storage.Weight()),
        ...
        "jetflav_btagDeepFlavCvB": Hist.Hist(lepflav_axis,region_axis,flav_axis,Hist.axis.Regular(50,0.5,1, name="discr", label="Discr"),Hist.storage.Weight()),
        ...
        "BDT_2D":Hist.Hist(region_axis,Hist.axis.Regular(50,0.,1, name="BDT_bkg", label="BDT(H+c,Other Bkg)"),Hist.axis.Regular(50,0.,1, name="BDT_H", label="BDT(H+c,Bkg-H)"),Hist.storage.Weight()),
