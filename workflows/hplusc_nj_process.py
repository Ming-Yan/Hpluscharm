...
class NanoProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        global_cut = (leppair.lep1.pt>25) & (leppair.lep1.charge+leppair.lep2.charge==0)  & (ll_cand.mass<120) & (ll_cand.mass>60)
        ...
        mask2e =  ak.any(global_cut,axis=-1) & (ak.num(event_e)==2)& (event_e[:,0].pt>25) & (event_e[:,1].pt>13)
        mask2mu =  ak.any(global_cut,axis=-1) & (ak.num(event_mu)==2)& (event_mu[:,0].pt>25) &(event_mu[:,1].pt>13)
        ...
        seljet = (corr_jet.pt > 20) & (abs(corr_jet.eta) <= 2.4)&((corr_jet.puId > 6)|(corr_jet.pt>50)) &(corr_jet.jetId>5)#&ak.all(corr_jet.metric_table(leppair.lep1)>0.4,axis=2)&ak.all(corr_jet.metric_table(leppair.lep2)>0.4,axis=2)
